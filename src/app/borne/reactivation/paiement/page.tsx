  ...
  return (
    <div className="flex flex-col w-full pb-8 animate-in fade-in zoom-in-95 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
        ...
        <Card className="p-4">
          <h3 className="font-bold text-primary mb-4 text-base">Récapitulatif</h3>
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="font-bold text-primary">Réactivation puce</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 mb-8">
            ...
            <div>
              ...
              <p className="font-bold text-primary text-xl">10 000 GNF</p>
            </div>
          </div>
      ...
      <div className="bg-white border border-border-light rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between shadow-sm gap-3">
         ...
         <div className="flex gap-4">
            ...
            <Button 
              ...
              onClick={() => router.push("/borne/reactivation/recu")}
