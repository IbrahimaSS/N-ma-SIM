      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <Card className="p-8 flex flex-col items-center text-center justify-center">
          ...
          <div className="w-full border-t border-b border-dashed border-border-light py-6 mb-6">
            <p className="text-4xl font-extrabold text-accent tracking-wider">NMA-RE-0092</p>
          </div>
              ...
              <table className="w-full text-sm">
                <tbody>
                  <tr className="border-b border-gray-100">
                    <td className="py-3 font-semibold text-primary">Numéro réactivé</td>
                    <td className="py-3 text-text-muted text-right font-bold text-primary">06 12 34 56 78</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    <td className="py-3 font-semibold text-primary">Nom du client</td>
                    <td className="py-3 text-text-muted text-right">Jean Paul KOUASSI</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                  ...
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="py-3 text-text-muted text-right">NMA-RE-0092</td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    <td className="py-3 font-semibold text-primary">Date</td>
                    <td className="py-3 text-text-muted text-right">24/05/2026 à 15:10</td>
                  </tr>
                  <tr>
