...
export default function ReactivationSelfie() {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      // vers la vérification malgré la décision "❌ REJETÉ" du moteur KYC.
      ...
      if (isRejected) {
        ...
        // immédiate), pas de retour à l'écran de choix. Les autres motifs (mineur, document
        // expiré...) ne se règlent pas en reprenant une photo : message affiché sans réouverture auto.
      ...
      setSuccessTarget("/borne/reactivation/verification");
    } catch (err) {
