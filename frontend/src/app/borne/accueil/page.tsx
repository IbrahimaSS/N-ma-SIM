      ...
      <div style={{
        ...
        <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: 16, marginBottom: 24 }}>
          ...
          <div style={{
            ...
            {/* Malinké */}
            <button data-ai-action="btn-lang-mal" onClick={() => { setLang("mal"); setProfile("resident"); }} style={{
              flex: 1, height: 54,
              display: "flex", alignItems: "center", justifyContent: "center", gap: 6,
              fontWeight: 700, fontSize: 13,
              color: lang === "mal" ? "#1F6B2D" : "#9CA3AF",
              background: lang === "mal" ? "rgba(31,107,45,0.07)" : "transparent",
              border: "none",
              borderLeft: "1px solid #E5E7EB",
